...
import { FilterTextboxComponent } from '../customers/filterTextbox.component';
...
@Component({
  ...
  directives: [CORE_DIRECTIVES, RouterLink, FilterTextboxComponent, SortByDirective, CardComponent],
